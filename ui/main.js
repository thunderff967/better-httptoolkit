...
let data = new Uint8Array(buffer);
    ...
    return b.createElement(aO, null,
        b.createElement(iO, null,
            b.createElement(lO, null, "Utils"),
            editingRule ? b.createElement(Dp, { collapsed: false, expanded: true },
                b.createElement("header", null, editingRule === "new" ? "Add Auto-Decryption Rule" : "Edit Auto-Decryption Rule"),
                b.createElement(cO, null,
                    b.createElement(uh, null, "Rule Name"),
                    b.createElement(Kp, {
                        type: "text",
                        value: name,
                        onChange: ev => setName(ev.target.value)
                    }),
                    b.createElement(uh, null, "Match Method"),
                    b.createElement(Jp, {
                        value: matchMethod,
                    ...
                    b.createElement(uh, null, "Apply Decryption to"),
                    b.createElement(Jp, {
                        value: applyTo,
                    ...
                    b.createElement(uh, null, "Match Host / URL Substring"),
                    b.createElement(Kp, {
                        type: "text",
                ...
                b.createElement("div", { style: { display: "flex", gap: "10px", marginTop: "20px", justifyContent: "flex-end" } },
                    ...
                    b.createElement(Wp, { onClick: handleSave }, "Save")
                )
                    ...
                    rules.map(rule => b.createElement(Dp, { key: rule.id, collapsed: false, expanded: true },
                        b.createElement("div", {
                            ...
                            b.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "4px" } },
                                b.createElement("div", { style: { fontWeight: "bold", fontSize: "15px" } }, rule.name),
                                b.createElement("div", { style: { fontSize: "13px", color: "rgba(255,255,255,0.6)" } },
                                    b.createElement("span", { style: { backgroundColor: "rgba(255,255,255,0.1)", padding: "2px 6px", borderRadius: "3px", marginRight: "6px", fontWeight: "bold" } }, rule.matchMethod),
                                    b.createElement("span", { style: { backgroundColor: "rgba(255,255,255,0.05)", padding: "2px 6px", borderRadius: "3px", marginRight: "6px", fontSize: "11px" } }, (rule.applyTo || "both").toUpperCase()),
                                    "matches URL containing: ",
                                    b.createElement("code", { style: { color: "#00bc8c", fontFamily: "monospace" } }, rule.matchUrl)
                                ),
                                b.createElement("div", { style: { fontSize: "12px", color: "rgba(255,255,255,0.4)", marginTop: "2px" } },
                            ...
                            b.createElement("div", { style: { display: "flex", gap: "8px" } },
                                b.createElement(_p, { onClick: () => handleEdit(rule) }, "Edit"),
                                b.createElement(_p, { onClick: () => handleDelete(rule.id) }, "Delete")
                            )
                        )
                    ))
                )

...
`,jO=G.div`
    color: red;
    margin: 16px 20px 0;
`,DO=(0,DE.PA)(({accountStore:e})=>{const t=b.useCallback(()=>{e.cancelLogin()},[]);return b.createElement(EO,{onClose:t},b.createElement(eh,{onClose:t}),b.createElement(FO,{accountStore:e}))}),MO=e=>{requestAnimationFrame(()=>null==e?void 0:e.focus())},FO=({accountStore:e})=>{const[t,n]=(0,b.useState)(""),[r,o]=(0,b.useState)(""),[s,a]=(0,b.useState)(!1),[i,l]=(0,b.useState)(!1),[c,d]=(0,b.useState)(!1),u=b.createElement($O,null,"By creating an account you accept the ",b.createElement("a",{href:"https://httptoolkit.com/terms-of-service/",target:"_blank"},"Terms of Service")," and ",b.createElement("a",{href:"https://httptoolkit.com/privacy-policy/",target:"_blank"},"Privacy Policy"),".");return s?b.createElement(SO,{onSubmit:n=>wO(void 0,void 0,void 0,function*(){n.preventDefault(),l(!0),d(!1);try{yield(0,zd.loginWithCode)(t,r),yield e.finalizeLogin(t)}catch(e){l(!1),d((0,vO.asErrorLike)(e).message||"An error occurred")}})},b.createElement(TO,{type:"button",onClick:()=>{a(!1),d(!1),o("")},"aria-label":"Go back"},b.createElement(is,{icon:["fas","arrow-left"],size:"2x"})),b.createElement(PO,null),b.createElement(kO,null,"Enter the code"),b.createElement(RO,null,"sent to you at",b.createElement("br",null),b.createElement(OO,null,t)),b.createElement(AO,{name:"otp",type:"text",required:!0,placeholder:"Enter the code",ref:MO,value:r,onChange:e=>{const t=e.target.value.slice(0,20);o(t)},disabled:i}),b.createElement("div",{style:{marginTop:"12px",marginBottom:"12px",display:"flex",flexDirection:"column",gap:"8px",fontSize:"13px",background:"rgba(255,255,255,0.05)",padding:"12px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.1)",textAlign:"left"}},b.createElement("div",{style:{fontWeight:"bold",color:"#38bdf8",marginBottom:"4px"}},"Available OTPs:"),[{name:"Vikend Leaks Chat",code:"VIKENDLEAKSCHAT"},{name:"Offline",code:"OFFL1NE"},{name:"Alpha Code",code:"ALPHAC0DE"},{name:"Beta Access",code:"BETAACCE5S"},{name:"Developer Dev",code:"DEVDEVM0DE"}].map(item=>b.createElement("button",{type:"button",style:{background:"rgba(56,189,248,0.1)",border:"1px solid #38bdf8",borderRadius:"4px",color:"#38bdf8",padding:"6px 12px",cursor:"pointer",textAlign:"left",display:"flex",justifyContent:"space-between",fontSize:"12px"},onClick:()=>o(item.code)},b.createElement("span",null,item.name),b.createElement("strong",null,item.code) ) ) ),c&&b.createElement(jO,null,c),b.createElement(BO,{type:"button",onClick:()=>e.cancelLogin()},"chnage choices"),b.createElement(CO,{type:"submit",disabled:i},i?b.createElement(qO,null):"Login"),u):b.createElement(SO,{onSubmit:e=>wO(void 0,void 0,void 0,function*(){e.preventDefault(),l(!0),d(!1);try{yield(0,zd.sendAuthCode)(t,"website"),l(!1),a(!0)}catch(e){l(!1),d((0,vO.asErrorLike)(e).message||"An error occurred")}})},b.createElement(PO,null),b.createElement(kO,null,"Enter your email"),b.createElement(HO,{name:"email",type:"email",required:!0,placeholder:"you@email.example",ref:MO,value:t,onChange:e=>n(e.target.value),disabled:i}),c&&b.createElement(jO,null,c),b.createElement(BO,{type:"button",onClick:()=>e.cancelLogin()},"chnage choices"),b.createElement(CO,{type:"submit",disabled:i},i?b.createElement(qO,null):"Send Code"),u)},BO=G(_p)`
    padding: 5px 20px;
    margin: 20px auto;

...
- To work on the UI and see it inside the desktop app, start the UI project (https://github.com/thunderff967/httptoolkit-ui) with `npm start`.
- Alternatively, run the server project (https://github.com/thunderff967/httptoolkit-server) with `npm start`, and `npm run start:web` in the UI project to run server + UI locally.
...
- For bugs or feature requests related to HTTP Toolkit itself, prefer filing issues at the main repo: https://github.com/thunderff967/httptoolkit/
